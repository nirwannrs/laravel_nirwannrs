                    ...
                    <table class="table-auto w-full text-left border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th class="border px-4 py-2">Nama RS</th>
                        ...
                        <tbody>
                            @foreach ($rumahSakits as $rumahSakit)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{ $rumahSakit->nama_rs }}</td>
                                    <td class="border px-4 py-2">{{ $rumahSakit->alamat }}</td>
                                    <td class="border px-4 py-2">{{ $rumahSakit->email }}</td>
                                    <td class="border px-4 py-2">{{ $rumahSakit->telepon }}</td>
